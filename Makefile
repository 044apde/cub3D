...
LDFLAGS		=	-Lmlx -lmlx -framework OpenGL -framework AppKit -fsanitize=address
SOURCE		=	main.c \
				...
				src/execute_cub3d/key_hook.c src/execute_cub3d/event_hook.c src/execute_cub3d/render_graphic.c \
